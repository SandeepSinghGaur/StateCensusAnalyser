   ...
   public class USACensusAdaptor: CensusAdapter
    {
        ...
        public Dictionary<string, CensusDTO> LoadCensusData(string csvFilePath, string dataHeaders)
        {
            ...
            foreach (string data in censusData.Skip(1))
            {
                ...
                if (csvFilePath.Contains("USCensusData.csv"))
                    dataMap.Add(coloumn[0], new CensusDTO(new USADataDAO(coloumn[0], coloumn[1], coloumn[2], coloumn[3], coloumn[4], coloumn[5], coloumn[6], coloumn[7], coloumn[8])));
            }
